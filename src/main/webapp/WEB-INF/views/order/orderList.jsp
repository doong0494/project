...
<input type="hidden" id="seat" value="${orderVO.orderno }">
<table>
   <tr><td>
      <img src="/files/${orderVO.image}" width="350" height="490">
      </td>
      <td>
         <table id="table2">
            <tr><th> 영화제목 </th><td>${orderVO.title}</td></tr>
            ...
            <tr><td>
              ...
              <input type="button" id="button2" style="background:gray; opacity:0.9; " value="취소하기" class="submit"
               onclick="go_mod_delete(${orderVO.orderno })"></td></tr>
         </table>
      </td>
   </tr>
</table>
...
function go_mod_delete(orderno){
	...
	var url="orderDelete?orderno=" + orderno;
	location.href=url;
	}
}
